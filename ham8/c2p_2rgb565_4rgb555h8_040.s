...
;
; About:
;   2byte RGB565 -> 4pixel RGBB5555 HAM8 C2P for contigous
...
;   most probably crash.
;
; c2p_2rgb565_4rgb555h8_040_init	sets screen & chunkybuffer parameters
; c2p_2rgb565_4rgb555h8_040		performs the actual c2p conversion
;
...
_c2p_2rgb565_4rgb555h8_040_init
c2p_2rgb565_4rgb555h8_040_init
	movem.l	d2-d6,-(sp)
	and.l	#$ffff,d0
	lsr.l	#3,d0
	move.l	d1,c2p_2rgb565_4rgb555h8_040_chunkyy
	move.l	d0,d1
	lsl.l	#4,d0
	move.l	d6,c2p_2rgb565_4rgb555h8_040_chunkymod
	move.l	d0,c2p_2rgb565_4rgb555h8_040_chunkyxlen
	sub.l	d0,d6
	move.l	d6,c2p_2rgb565_4rgb555h8_040_chunkyminimod
	move.l	d5,c2p_2rgb565_4rgb555h8_040_bplsize
	and.l	#$ffe0,d2
	and.l	#$ffff,d3
	lsr.l	#3,d2
	mulu.l	d4,d3
	add.l	d2,d3
	move.l	d3,c2p_2rgb565_4rgb555h8_040_scroffs
	lsl.l	#2,d1
	sub.l	d1,d4
	move.l	d4,c2p_2rgb565_4rgb555h8_040_bplmod
	movem.l	(sp)+,d2-d6
	rts
...
_c2p_2rgb565_4rgb555h8_040
c2p_2rgb565_4rgb555h8_040

	movem.l	d2-d7/a2-a6,-(sp)

	move.l	c2p_2rgb565_4rgb555h8_040_bplsize,a3
	add.l	c2p_2rgb565_4rgb555h8_040_scroffs,a1
	lea	(a1,a3.l*4),a1

	move.l	c2p_2rgb565_4rgb555h8_040_chunkyxlen,a2
	tst.l	a2
	beq	.none
	add.l	a0,a2

	move.l	c2p_2rgb565_4rgb555h8_040_chunkyy,d0
	subq.w	#1,d0
	beq	.none
...
.y	move.l	d0,-(sp)
	...
	add.l	c2p_2rgb565_4rgb555h8_040_bplmod,a1
	bra	.start
	cnop	0,16
.x
	move.l	(a0)+,d0
...
.start
	...
	add.l	c2p_2rgb565_4rgb555h8_040_chunkyminimod,a0
	add.l	c2p_2rgb565_4rgb555h8_040_chunkymod,a2
	move.l	(sp)+,d0
	dbf	d0,.y
...
c2p_2rgb565_4rgb555h8_040_scroffs	ds.l	1
c2p_2rgb565_4rgb555h8_040_bplsize	ds.l	1
c2p_2rgb565_4rgb555h8_040_chunkymod	ds.l	1
c2p_2rgb565_4rgb555h8_040_chunkyminimod ds.l	1
c2p_2rgb565_4rgb555h8_040_chunkyxlen	ds.l	1
c2p_2rgb565_4rgb555h8_040_bplmod	ds.l	1
c2p_2rgb565_4rgb555h8_040_chunkyy	ds.l	1
