...
UTEST(bitmap, c2p1x1_6_c5_bm_040) {
	...
	c2p1x1_6_c5_bm_040(chunkyx, chunkyy, scroffsx, scroffsy, random_320x256x6bpl_chunky, &bitmap);

	ASSERT_ARRAY_EQ(random_320x256x8bpl_planar, tempbuf, bplsize * depth);
}

UTEST(bitmap, c2p1x1_6_c5_bm_040_modulo) {
	...
	c2p1x1_6_c5_bm_040(chunkyx, chunkyy, scroffsx, scroffsy, random_224x240x6bpl_chunky, &bitmap);
