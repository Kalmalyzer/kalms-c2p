...
UTEST(bitmap, c2p1x1_4_c5_bm) {
	...
	c2p1x1_4_c5_bm(chunkyx, chunkyy, scroffsx, scroffsy, random_320x256x4bpl_chunky, &bitmap);

	ASSERT_ARRAY_EQ(random_320x256x8bpl_planar, tempbuf, bplsize * depth);
}

UTEST(bitmap, c2p1x1_4_c5_bm_modulo) {
	...
	c2p1x1_4_c5_bm(chunkyx, chunkyy, scroffsx, scroffsy, random_224x240x4bpl_chunky, &bitmap);
