...
.x2
	...
	move.l	#c2p1x1_8_cpu3blit1_41,c2p_bltroutptr-c2p_bltnode(a1)
	jsr	qblit
...
c2p1x1_8_cpu3blit1_41
	...
	move.w	#1,bltsizh(a0)
	move.l	#c2p1x1_8_cpu3blit1_42,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p1x1_8_cpu3blit1_42
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#1,bltsizh(a0)
	move.l	#c2p1x1_8_cpu3blit1_43,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p1x1_8_cpu3blit1_43
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#1,bltsizh(a0)
	move.l	#c2p1x1_8_cpu3blit1_44,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p1x1_8_cpu3blit1_44
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#1,bltsizh(a0)
	move.l	#c2p1x1_8_cpu3blit1_45,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p1x1_8_cpu3blit1_45
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#1,bltsizh(a0)
	move.l	#c2p1x1_8_cpu3blit1_46,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p1x1_8_cpu3blit1_46
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#1,bltsizh(a0)
	move.l	#c2p1x1_8_cpu3blit1_47,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p1x1_8_cpu3blit1_47
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#1,bltsizh(a0)
	move.l	#c2p1x1_8_cpu3blit1_48,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p1x1_8_cpu3blit1_48
