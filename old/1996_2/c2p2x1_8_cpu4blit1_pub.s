...
;	move.l	#c2p2x1_8_cpu4blit1_51,c2p_bltroutptr-c2p_bltnode(a1)
;	jsr	qblit
...
c2p2x1_8_cpu4blit1_51
	...
	move.w	#2,bltsizh(a0)
	move.l	#c2p2x1_8_cpu4blit1_52,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p2x1_8_cpu4blit1_52
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#2,bltsizh(a0)
	move.l	#c2p2x1_8_cpu4blit1_53,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p2x1_8_cpu4blit1_53
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#2,bltsizh(a0)
	move.l	#c2p2x1_8_cpu4blit1_54,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p2x1_8_cpu4blit1_54
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#2,bltsizh(a0)
	move.l	#c2p2x1_8_cpu4blit1_55,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p2x1_8_cpu4blit1_55
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#2,bltsizh(a0)
	move.l	#c2p2x1_8_cpu4blit1_56,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p2x1_8_cpu4blit1_56
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#2,bltsizh(a0)
	move.l	#c2p2x1_8_cpu4blit1_57,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p2x1_8_cpu4blit1_57
	...
	move.w	c2p_pixels16+2-c2p_bltnode(a1),bltsizv(a0)
	move.w	#2,bltsizh(a0)
	move.l	#c2p2x1_8_cpu4blit1_58,c2p_bltroutptr-c2p_bltnode(a1)
	rts

c2p2x1_8_cpu4blit1_58
