...
UTEST(normal, c2p1x1_8_c5_030_2) {
	...
	c2p1x1_8_c5_030_2_smcinit(chunkyx, chunkyy, scroffsy, bplsize);
	c2p1x1_8_c5_030_2(random_320x256x8bpl_chunky, tempbuf);
