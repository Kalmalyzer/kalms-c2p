...
;
; About:
;   1x1 8bpl cpu3 C2P for contigous bitplanes and no horizontal modulo
;
;   This routine is intended for use on all 68020-68060 systems
;   [aimed for 020-030 though, and does not reach copyspeed entirely on 040+]
;
...
;
; Timings:
;   Estimated to run almost at copyspeed on 040-40 and 060
;
; Features:
...
;   most probably crash.
;
; c2p1x1_8_c3_sc_gen_smcinit		sets the chunkybuffer size/pos
;					and relocs c2p innerloop (helps on 030)
; c2p1x1_8_c3_sc_gen_init		sets the chunkybuffer size/pos
; c2p1x1_8_c3_sc_gen			performs the actual c2p conversion
;
...
c2p1x1_8_c3_sc_gen_smcinit
	...
	mulu.w	d0,d3
	lsr.l	#3,d3
	move.l	d3,c2p1x1_8_c3_sc_gen_scroffs
	mulu.w	d0,d1
	move.l	d1,c2p1x1_8_c3_sc_gen_pixels

	move.l	c2p1x1_8_c3_sc_gen_relocinfo-8,d0
	move.l	c2p1x1_8_c3_sc_gen_relocinfo-4,d1
	move.l	d0,a0
	move.b	d0,d3
	andi.b	#$f0,d0
	cmp.b	d0,d3
	beq.s	.nreloc
	move.l	d0,c2p1x1_8_c3_sc_gen_relocinfo-8
	move.l	d0,a1
	subq.w	#1,d1
.reloc	move.b	(a0)+,(a1)+
	dbf	d1,.reloc
	andi.b	#$f,d3
	move.l	c2p1x1_8_c3_sc_gen_relocinfo-12,a0
	sub.b	d3,-1(a0)
.nreloc
...
c2p1x1_8_c3_sc_gen
	...
	add.w	#BPLSIZE,a1
	add.l	c2p1x1_8_c3_sc_gen_scroffs,a1
	move.l	a1,a2
	add.l	#BPLSIZE*4,a2

	move.l	#$55555555,a3

	move.l	c2p1x1_8_c3_sc_gen_pixels,d0
	beq	.none
	add.l	a0,d0
	move.l	d0,-(sp)
...
.routend
	...
	dc.l	.x
	dc.l	.routend-.x
c2p1x1_8_c3_sc_gen_relocinfo

	section	bss,bss

c2p1x1_8_c3_sc_gen_scroffs	ds.l	1
c2p1x1_8_c3_sc_gen_pixels	ds.l	1
