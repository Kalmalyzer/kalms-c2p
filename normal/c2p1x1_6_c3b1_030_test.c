...
UTEST_F(normal, c2p1x1_6_c3b1_030) {
	...
	c2p1x1_6_c3b1_030_init(chunkyx, chunkyy, scroffsy, bplsize);
	c2p1x1_6_c3b1_030(random_320x256x6bpl_chunky, utest_fixture->tempbuf_chipmem, utest_fixture->tempbuf_chipmem + 256 * 256 * 2);
