...
UTEST_F(normal, c2p2x1_6_c4b1_gen) {
	...
	c2p2x1_6_c4b1_gen_init(chunkyx, chunkyy, scroffsy, bplsize);
	c2p2x1_6_c4b1_gen(random_160x256x6bpl_chunky, utest_fixture->tempbuf_chipmem, utest_fixture->tempbuf_chipmem + 256 * 256 * 2);
