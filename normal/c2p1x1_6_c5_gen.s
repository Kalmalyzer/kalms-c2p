...
; d5.l	(bplsize) [bytes] -- offset between one row in one bpl and the next bpl
	...
	XDEF	_c2p1x1_6_c5_gen_init
	XDEF	c2p1x1_6_c5_gen_init
_c2p1x1_6_c5_gen_init
c2p1x1_6_c5_gen_init
	movem.l	d2-d3,-(sp)
	andi.l	#$ffff,d0
	mulu.w	d0,d3
	lsr.l	#3,d3
	move.l	d3,c2p1x1_6_c5_gen_scroffs
	mulu.w	d0,d1
	move.l	d1,c2p1x1_6_c5_gen_pixels
	movem.l	(sp)+,d2-d3
	rts
...
; a1	bitplanes
	...
	XDEF	_c2p1x1_6_c5_gen
	XDEF	c2p1x1_6_c5_gen
_c2p1x1_6_c5_gen
c2p1x1_6_c5_gen
	...
	add.w	#BPLSIZE,a1
	add.l	c2p1x1_6_c5_gen_scroffs,a1

	move.l	c2p1x1_6_c5_gen_pixels,a2
	add.l	a0,a2
	cmp.l	a0,a2
	beq	.none
...
c2p1x1_6_c5_gen_scroffs	ds.l	1
c2p1x1_6_c5_gen_pixels	ds.l	1
